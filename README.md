...
A newbie project for learning purpose. Creating a Coffee Machine that have some capabilities.
We can buy a coffee, fill the machine, take the cash, check the remaining ingredients, and
